...
namespace Drupal\brmalls_login\Controller;
...
use Drupal\brmalls_login\UserAuthInterface;
use Drupal\brmalls_login\UserInterface;
use Drupal\brmalls_login\UserStorageInterface;

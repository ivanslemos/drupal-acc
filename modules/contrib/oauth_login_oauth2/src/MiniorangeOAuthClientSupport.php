  ...
  /**
    ...
    public function sendSupportQuery()
    {
        ...
        if ($this->plan == 'demo') {
            ...
            $content = '<div >Hello, <br><br>Company :<a href="' . $_SERVER['SERVER_NAME'] . '" target="_blank" >' . $_SERVER['SERVER_NAME'] . '</a><br><br>Phone Number:' . $this->phone . '<br><br>Email:<a href="mailto:' . $this->email . '" target="_blank">' . $this->email . '</a><br><br>Query:[DRUPAL ' . Utilities::mo_get_drupal_core_version() . ' OAuth Login Free | '.$modules_version.' ] ' . $this->query . '</div>';
            ...
            $this->query = '[Drupal ' . \DRUPAL::VERSION . ' OAuth Login Free Module | '.$modules_version.' ] ' . $this->query;
            $fields = array(

                        ...
                        <form name="f" action="<?php echo $feedback_url; ?>" id="mo_feedback">
                            <div>
                                ...
                                <div class="mo2f_modal-footer">
                                    <input type="submit" id="submit_button" name="miniorange_feedback_submit" class="button btn btn-primary" value="Submit and Continue" style="margin: auto; display: block; font-size: 11px;"/>
                                </div>
                                <?php

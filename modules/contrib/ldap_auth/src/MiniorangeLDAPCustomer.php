...
class MiniorangeLDAPCustomer {
  ...
  public function checkCustomer() {
    ...
    $url = MiniorangeLDAPConstants::BASE_URL . '/moas/rest/customer/check-if-exists';
    $ch = curl_init($url);
    $email = $this->email;
    ...
    if (curl_errno($ch)) {
      ...
      watchdog('miniorange_ldap', 'Error at %method of %file: %error', $error);
    }
    curl_close($ch);
  ...
  public function createCustomer() {
    ...
    $url = MiniorangeLDAPConstants::BASE_URL . '/moas/rest/customer/add';
    $ch = curl_init($url);
    $fields = array(
      'companyName' => $_SERVER['SERVER_NAME'],
      'areaOfInterest' => \Drupal::VERSION.'Login with LDAP/NTLM',
      'email' => $this->email,
      'phone' => $this->phone,
  ...
  public function getCustomerKeys() {
    ...
    $url = MiniorangeLDAPConstants::BASE_URL . '/moas/rest/customer/key';
    $ch = curl_init($url);
    $email = $this->email;
    $password = $this->password;
  ...
  public function sendOtp() {
    ...
    $url = MiniorangeLDAPConstants::BASE_URL . '/moas/api/auth/challenge';
    $ch = curl_init($url);
  ...
  public function validateOtp($transaction_id) {
    ...
    $url = MiniorangeLDAPConstants::BASE_URL . '/moas/api/auth/validate';
    $ch = curl_init($url);
